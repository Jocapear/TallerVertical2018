...
class Custom_Functions {
  ...
  public $firebase_url = 'https://taller-vertical-2018.firebaseio.com';
  public $firebase_key = '';
  ...
  public function include_custom_metabox_helper() {
    $this::include_helper('metaboxes-and-fields/init.php');
  }
  ...
  private function send_to_firebase($key, $value) {
    $this::include_helper('firebase-php/firebaseLib.php');
    $firebase = new Firebase($this->firebase_url, $this->firebase_key);
